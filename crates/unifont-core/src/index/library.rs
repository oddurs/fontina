...
/// How a face was made available to the OS through unifont.
...
impl Index {
    ...
    pub fn import_collection(
        ...
        if export.schema_version > crate::SCHEMA_VERSION {
            return Err(Error::Other(format!(
                "collection was written by a newer unifont (schema {} > {})",
    ...
    /// Every activation unifont has recorded, in listing order.
    ...
    /// PostScript name, or same family and style, and already active through unifont or
