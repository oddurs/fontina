...
```
$ fontina list --script Arab          # faces whose cmap covers Arabic
$ fontina list --variable             # variable fonts
$ fontina list --license OFL          # by SPDX identifier prefix
$ fontina list --weight 600-900       # by CSS font-weight range
$ fontina list --vendor ADBE          # by OS/2 vendor id
$ fontina list grotesque              # full-text search over names and designer
```
...
```
$ fontina info 2
$ fontina info ~/Downloads/Mystery.ttf
```
...
```
$ fontina covers "Þórður át 12 blóðbergsbrauð"
```
