...
title: Security
description: "The fontina security policy and how to report a vulnerability privately."
...
[github.com/oddurs/fontina/security/advisories/new](https://github.com/oddurs/fontina/security/advisories/new),
or email <oddurs@gmail.com> with `[fontina security]` in the subject.

Include the font file that triggers the problem if you can share it, or the
`fontina info --json` output and a description of how the file was produced.
...
- `fontina-core`: parsing, WOFF and WOFF2 decoding, and the SQLite index
- the `fontina` command line
- release artifacts and the build pipeline

Out of scope: vulnerabilities in fonts themselves, or in operating-system font
rasterisers that fontina does not ship.
