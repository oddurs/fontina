...
description: "Where and how to report a bug in fontina, and what to include."
source: site/src/pages/bugs.md
---

Bugs are tracked at
[github.com/oddurs/fontina/issues](https://github.com/oddurs/fontina/issues). Search
...
1. The output of `fontina --version` and your operating system and version.
...
3. For a parsing or metadata problem: the font file, if its license allows sharing it.
   If not, the output of `fontina info --json <file>` and the font's origin.
...
If fontina reports a family, weight, script coverage, license or feature that is not
...
the fix is upstream, and fontina will not hand-parse around it.

## Feature requests

Welcome, in the same tracker. Read the [roadmap](../roadmap/) first, including the list
of things fontina will never do.
